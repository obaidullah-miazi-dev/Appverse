...
const AppNotFoundErrorPage = () => {
    return (
        <div className='h-screen text-center space-y-5 mt-48'>
            <img src={ErrorPng} alt="error image" className='flex mx-auto' />
            <h1 className='text-5xl font-bold'>OPPS!! APP NOT FOUND</h1>
            <p className='font-semibold text-xl'>The App you are requesting is not found on our system.  please try another apps</p>
