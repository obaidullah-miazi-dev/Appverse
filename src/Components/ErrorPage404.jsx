...
const ErrorPage404 = () => {
    return (
        <div className='h-screen text-center space-y-5 mt-48'>
            <img src={Error404Img} alt="error image" className='flex mx-auto md:w-80 w-36' />
            <h1 className='md:text-5xl text-3xl px-1  font-bold'>Oops, page not found!</h1>
            <p className='font-semibold px-1 md:text-xl'>The page you are looking for is not available.</p>
